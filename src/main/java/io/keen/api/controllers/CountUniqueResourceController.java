...
public class CountUniqueResourceController extends BaseController {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static CountUniqueResourceController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the CountUniqueResourceController class 
     */
    public static CountUniqueResourceController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new CountUniqueResourceController();
            }
        }
        return instance;
    }
     ...
     */
    public void getCountUniqueResourceAsync(
                final GetCountUniqueResourceInput input,
        ...
        _queryBuilder.append("/{version}/projects/{project_id}/queries/count_unique");

        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5491047735662532778L;
            {
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4688634764569517140L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4728655145557521182L;
            {
