...
public class CountResourceController extends BaseController {    
    ...
    private static CountResourceController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the CountResourceController class 
     */
    public static CountResourceController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new CountResourceController();
            }
        }
        return instance;
    }
     ...
     */
    public void getCountResourceAsync(
                final GetCountResourceInput input,
        ...
        _queryBuilder.append("/{version}/projects/{project_id}/queries/count");

        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5321678274267502296L;
            {
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4748967874911004545L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5521185367316512604L;
            {
