...
public class MedianResourceController extends BaseController {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static MedianResourceController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the MedianResourceController class 
     */
    public static MedianResourceController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new MedianResourceController();
            }
        }
        return instance;
    }
     ...
     */
    public void getMedianResourceAsync(
                final GetMedianResourceInput input,
        ...
        _queryBuilder.append("/{version}/projects/{project_id}/queries/median");

        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5155202439924185272L;
            {
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5598930239271191209L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4739430269139027974L;
            {
