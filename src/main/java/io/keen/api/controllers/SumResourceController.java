...
public class SumResourceController extends BaseController {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static SumResourceController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the SumResourceController class 
     */
    public static SumResourceController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new SumResourceController();
            }
        }
        return instance;
    }
     ...
     */
    public void getSumResourceAsync(
                final GetSumResourceInput input,
        ...
        _queryBuilder.append("/{version}/projects/{project_id}/queries/sum");

        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5140878206918759885L;
            {
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5471373529216717071L;
            {
                    put( "api_key", input.getApiKey() );
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4695638750141285315L;
            {
