...
public class MinimumResourceController extends BaseController {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static MinimumResourceController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the MinimumResourceController class 
     */
    public static MinimumResourceController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new MinimumResourceController();
            }
        }
        return instance;
    }
     ...
     */
    public void getMinimumResourceAsync(
                final GetMinimumResourceInput input,
        ...
        _queryBuilder.append("/{version}/projects/{project_id}/queries/minimum");

        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5051421552593665099L;
            {
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5291473381834909430L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5275955582611432608L;
            {
